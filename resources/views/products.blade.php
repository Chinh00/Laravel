                                        ...
                                        <div class="col-6 col-md-4 col-lg-4 col-xl-3">
											<div class="product product-7 text-center">
												<figure class="product-media">
													...
													<a href="/phone/{{$key->slug}}/{{$key->id}}">
														<img src="{{asset('images/' . $key->image)}}" alt="Product image" class="product-image">
													</a>

													<div class="product-action-vertical">
														<a href="/quickView/{{$key->id}}" class="btn-product-icon btn-quickview" title="Quick view"><span>Xem nhanh</span></a>
												...
												<div class="product-body">
													...
													<h3 class="product-title"><a href="">{{$key->name}}</a></h3><!-- End .product-title -->
													...
													<div class="product-nav product-nav-thumbs">
														...
														@if(isset($a))
															@foreach($a as $key => $val)
																<a href="#" class="active">
																	<img src="{{asset('images/' . $val)}}" alt="product desc">
																</a>
															@endforeach
														@endif
													</div><!-- End .product-nav -->
                		...
                		<aside class="col-lg-3 order-lg-first">
                			<div class="sidebar sidebar-shop">
                				...
                				<div class="widget widget-collapsible">
									...
									@php
										$brands = DB::table("categories")->get();
									@endphp
												...
												@foreach($brands as $key)
													<div class="filter-item">
														<div class="custom-control custom-checkbox">
															<a href="/phone/{{$key->slug}}" class="btn btn primary">{{$key->category_name}}</a>
									...
									<div class="collapse" id="widget-3">
										<div class="widget-body">
												<div class="filter-items filter-items-count">
													<div class="filter-item">
														<div class="custom-control custom-checkbox">
															<a href="/sort/price/desc" class="btn btn primary">Giá giảm dần</a>
														</div><!-- End .custom-checkbox -->
													</div><!-- End .filter-item -->
													<div class="filter-item">
														<div class="custom-control custom-checkbox">
															<a href="/sort/price/asc" class="btn btn primary">Giá tăng dần</a>
														</div><!-- End .custom-checkbox -->
													</div><!-- End .filter-item -->
													<div class="filter-item">
														<div class="custom-control custom-checkbox">
															<a href="/sort/name" class="btn btn primary">Theo tên</a>
														</div><!-- End .custom-checkbox -->
													</div><!-- End .filter-item -->
											</div><!-- End .filter-items -->
										</div><!-- End .widget-body -->
